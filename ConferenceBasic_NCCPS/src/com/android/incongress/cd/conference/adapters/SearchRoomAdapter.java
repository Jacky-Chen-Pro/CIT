...
public class SearchRoomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    public SearchRoomAdapter(Context ctx, List<ClassesBean> classes) {
        this.mContext = ctx;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ClassesBean bean = mClasses.get(position);
        ...
        if(AppApplication.systemLanguage == 1) {
            ...
            ((SearchRoomHolder) holder).tvRoom.setText(bean.getClassesCodeEn());
            roomBean.setRoomeName(bean.getClassesCodeEn());
        }
