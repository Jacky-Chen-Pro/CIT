...
import com.android.incongress.cd.conference.fragments.search_schedule.SegmentProfessorFragment;
import com.android.incongress.cd.conference.fragments.search_schedule.SegmentScheduleFragment;
...
public class SegmentSearchAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        if(position == 0) {
            return new SegmentScheduleFragment();
        }else if(position == 1) {
//            return new SegmentProfessorFragment();
